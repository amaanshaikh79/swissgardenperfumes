                ...
                <motion.div className="auth-card" initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                    ...
                    <motion.form className="auth-form" onSubmit={handleEmailLogin} {...fadeSlide}>
                        ...
                        <div className="auth-social-buttons">
                            <button className="auth-social-btn auth-social-google" onClick={() => window.location.href = '/api/auth/google'}>
                                <GoogleIcon />
                                <span>Google</span>
                            </button>
                            <button className="auth-social-btn auth-social-facebook" onClick={() => window.location.href = '/api/auth/facebook'}>
                                <FiFacebook size={20} />
                                <span>Facebook</span>
                            </button>
                        </div>
