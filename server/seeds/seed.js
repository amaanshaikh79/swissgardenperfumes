...
const products = [
    ...
    {
        name: 'The swissgarden Discovery Set',
        brand: 'swissgarden',
        description:
            'Experience the best of swissgarden with this curated discovery set. Contains 5 miniatures of our top-selling fragrances: Dark Oud Elixir, Rose Velvet, Aqua Marine, Noir Intense, and Citrus Rush — each 10ml. Presented in a premium gift box. The perfect way to find your signature scent.',
        shortDescription: 'Curated 5-piece discovery set – the perfect gift',
        price: 999,
        compareAtPrice: 1499,
        images: [
            { url: 'https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=800', alt: 'The swissgarden Discovery Set' },
        ],
        category: 'Gift Set',
        gender: 'Unisex',
        size: '5 x 10ml',
