...
const products = [
    ...
    // ── 02 BLUE DOMINION ─────────────────────────────────────────────────────
    {
        ...
        season: ['All Year'],
        moodProfile: ['Confident', 'Electric', 'Unapologetic'],
        bestFor: 'Evening outings, travel, moments of deliberate self-expression',
        ...
        pairsWith: [
            { name: 'Royal Ascent', slug: 'royal-ascent', description: 'Layer for The Boardroom — a combination so assured it could close deals on its own' },
            { name: 'Glacier Splash', slug: 'glacier-splash', description: 'Add for Blue Ice — cold, deep, electric, unlike anything else' },
        ],
        format: '10ml · Non-Alcoholic · Roll-On Attar · ₹499',
    },
